...
use sysinfo::{CpuRefreshKind, DiskRefreshKind, MemoryRefreshKind, RefreshKind};
...
pub fn ui(frame: &mut Frame, app: &App) {
    ...
    let gpu = Block::default()
        .borders(Borders::ALL)
        .title("GPU")
        .style(Style::default().yellow());

    let memory_data = Block::default()
        .borders(Borders::ALL)
        .title("MEMORY")
    ...
    let net = Block::default()
        .borders(Borders::ALL)
        .title("NET")
        .style(Style::default().magenta());

    let disk_data = Block::default()
        .borders(Borders::ALL)
        .title("DISK")
